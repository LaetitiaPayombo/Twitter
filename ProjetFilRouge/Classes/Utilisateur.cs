...
namespace ProjetFilRouge.Classes
{
    class Utilisateur
    {
        ...
        {
            Utilisateur u = DataBase.TrouverUtilisateurParID(Id);
            if (u != null)
                ;
            else
        ...
        {
            Utilisateur u = DataBase.TrouverUtilisateurParPseudo(pseudo);
            if (u != null)
                ;
            else
                MessageBox.Show("L'utilisateur n'existe pas ", "Recherche Utilisateur", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        {
            Utilisateur u = DataBase.TrouverUtilisateurParEmail(email);
            if (u != null)
                ;
            else
                MessageBox.Show("L'utilisateur n'existe pas ", "Recherche Utilisateur", MessageBoxButton.OK, MessageBoxImage.Information);
